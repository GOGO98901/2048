...
import me.roryclaasen.game.graphics.TextObject;
...
public class GamePanel {
	...
	public GamePanel(GameCanvas canvas) {
		this.canvas = canvas;
	...
	private void updateSizes() {
		...
		graphics.get("play").getBounds().setLocation(buttonX, buttonY);
		graphics.get("restart").getBounds().setLocation(buttonX, buttonY);
		graphics.get("exit").getBounds().setLocation(buttonX + grids - buttonWidth, buttonY);
